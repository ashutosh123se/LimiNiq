...
export function FloatingContactBar() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-0 right-0 z-[200] px-4 pointer-events-none flex items-end justify-between">
        ...
        <motion.div
          ...
          className="pointer-events-auto flex items-center bg-black/40 backdrop-blur-xl border border-white/10 rounded-full p-1.5 shadow-2xl relative overflow-hidden"
        >
          <div className="flex items-center gap-2 px-3">
            ...
            <a
              ...
              className="w-10 h-10 rounded-full hover:bg-white/10 flex items-center justify-center text-white/80 hover:text-white transition-colors mr-2"
            >
          ...
          <Link
            href="/contact"
            className="bg-white hover:bg-gray-100 text-black font-semibold px-6 py-2.5 rounded-full transition-colors flex-shrink-0"
          >
            Book Call
          </Link>
        </motion.div>
